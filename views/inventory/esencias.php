<section class="content-panel" id="esenciasModule" data-inventory-config='{"categoria":"Esencias","contenedorSelector":".content-inventory-esencias","cantidadId":"#cantidad-esencias","accionListar":"listarEsencias","tieneSedes":false,"esEsencia":true,"idModalPresentacion":"#modalRegistroPresentacion"}'>
    <div class="row">
        <div class="col-md-8">
            <h1>Inventario Esencias</h1>
            <p>(Cantidad de esencias: <span id="cantidad-esencias">0</span>)</p>
        </div>

        <div class="col-md-4 d-flex justify-content-end align-items-start">
            <button type="button" class="btn btn-new-product" data-bs-toggle="modal" data-bs-target="#modalRegistroProducto"><i class="fa-solid fa-plus"></i> Nueva Esencia</button>
...
<section>
    ...
    <div class="content-inventory-esencias"></div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="modal-cabecera">
                    <h3 class="modal-title" id="staticBackdropLabel">Registrar Esencia</h3>
                    ...
                    <form action="" id="formRegistroProducto">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" id="nombreProducto" name="nombreProducto" placeholder="Ej: Esencia 212 Men">
                                
                            </div>

                            <div class="col-md-4">
                                <label for="codigoProducto" class="form-label">Codigo Esencia</label>
                            ...
                            <div id="collapseExistentes" class="accordion-collapse collapse">
                                <div class="accordion-body p-0">
                                    <table class="table table-sm table-dark mb-0">
                                        <thead><tr><th>Nombre</th><th>Código</th><th class="text-center">P. Compra</th><th class="text-center">Stock (g)</th><th></th></tr></thead>
