<section class="content-panel">
    <div class="row">
        <div class="col-md-10">
            <h1>Inventario</h1> <p>(Cantidad de productos: <span id="cantidad-productos">0</span>)</p>
        </div>

        <div class="col-md-2">
            <button type="button" class="btn btn-new-product"><i class="fa-solid fa-plus"></i> Nuevo Producto</button>
        </div>
    </div>
</section>
