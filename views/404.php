...
<head>
    ...
    <title>404 - Página No Encontrada | JM Distribuciones</title>
    ...
    <div class="error-container">
        <div class="error-card">
            ...
            <div class="error-details">
                <strong>💡 Consejo:</strong> Asegúrate de que la ruta sea correcta. Si el problema persiste, contacta con soporte.
            </div>
